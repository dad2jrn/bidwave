...
export function ListingDetailPage() {
    ...
    const minimumBid = listing ? listing.currentBid + 1 : 0;
    ...
    if (!listing) {
        return (
            <div className="text-center py-20">
                ...
                <Link to="/" className="bg-blue-700 text-white px-6 py-2.5 rounded-lg hover:bg-blue-800 transition-colors">
                    Back to Browse
                </Link>
            </div>
        );
                ...
                <div>
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 mb-6">
                        ...
                        <p className="text-xs text-blue-500">
                            {listing.bids.length} bid{listing.bids.length !== 1 ? 's' : ''} placed
                        </p>
                        {!isEnded && (
                    ...
                    {isEnded ? (
                        <div className="bg-gray-100 rounded-xl p-5 text-center text-gray-500">
                            ...
                            <p className="text-sm mt-1">
                                Final price: {formatCurrency(listing.currentBid)}
                            </p>
                        </div>
                    ) : (
                        <form onSubmit={handleBid} className="space-y-3">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-blue-700 text-white py-2.5 rounded-lg font-semibold
